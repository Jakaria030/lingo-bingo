        ...
        <div className='w-11/12 sm:w-10/12 mx-auto'>
            ...
            <section>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 mb-10">
                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={htmlIcon} />
                        <h3 className="text-xl font-semibold">HTML</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={cssIcon} />
                        <h3 className="text-xl font-semibold">CSS</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={tailwindIcon} />
                        <h3 className="text-xl font-semibold">Tailwind</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={jsIcon} />
                        <h3 className="text-xl font-semibold">JavaScript</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={reactIcon} />
                        <h3 className="text-xl font-semibold">React</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={firebaseIcon} />
                        <h3 className="text-xl font-semibold">Firebase</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={cplusIcon} />
                        <h3 className="text-xl font-semibold">C++</h3>
                    </div>

                    <div className="border border-primary/80 p-5 flex flex-col items-center justify-center rounded-md">
                        <img className="size-20" src={pythonIcon} />
